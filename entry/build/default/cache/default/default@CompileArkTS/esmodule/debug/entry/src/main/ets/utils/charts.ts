import type { AxisInterface, LegendInterface, TooltipInterface, SeriesInterface, InterfaceObj, DataZoomInterface, RadarInterface } from './chartInterface';
import { deepCopy } from "@bundle:com.example.mccharts/entry/ets/utils/index";
import { seriesOpt, xAxisOpt, yAxisOpt, tooltip, legend, legendTextStyle, dataZoom, radar } from "@bundle:com.example.mccharts/entry/ets/utils/defaultOption";
import { percentageConversion, roundRect } from "@bundle:com.example.mccharts/entry/ets/utils/index";
...
export class Chart {
    ...
    bindZoomScale(scale) {
        ...
        if ((xEnd - xStart <= 1 && delta > 0) || (xStart === 0 && xEnd === xl - 1 && delta < 0))
            return;
