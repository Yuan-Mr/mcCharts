...
import DrawPoint from "@bundle:com.example.mccharts/entry/ets/utils/drawPoint";
...
export class McPointChart extends ViewPU {
    ...
    setInitiallyProvidedValue(params: McPointChart_Params) {
    ...
    updateStateVars(params: McPointChart_Params) {
        this.__options.set(params.options);
    }
    ...
    initialRender() {
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/components/mainpage/McPointChart.ets", line: 25 });
